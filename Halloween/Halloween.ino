...
extern const byte rgbArray[4][11][36][3]PROGMEM;
...
void loop() {
  ...
  //rainbowCycle(20);
   ...
   colorWipe(strip.Color(0, 170, 0), 100, false); // green
  delay(1000);  
  colorWipe(strip.Color(255, 150, 0), 150, true); // organge
    colorWipe(strip.Color(255, 70, 0), 150, true); // organge
  //colorWipe(strip.Color(127, 127, 127), 100, false); // WHITE/*
  delay(2000);  
  colorWipe(strip.Color(255, 165, 0), 200, true); // orange-red
  //colorWipe(strip.Color(255, 215, 127), 250, true); // Red
  colorWipe(strip.Color(255, 70, 0), 200, true); // organge  
  colorWipe(strip.Color(0, 0, 0), 200, false); // OFF/*
   delay(3000);  
  ...
  for (int image=0; image < 4; image++) {
    ...
    for (int xx=0; xx < 11; xx++) {
      ...
      for(int y = 0; y < 36; y++) {    
          ...
          int r = pgm_read_byte(&(rgbArray[image][xx][yy][0]));
          int g = pgm_read_byte(&(rgbArray[image][xx][yy][1]));
          int b = pgm_read_byte(&(rgbArray[image][xx][yy][2]));
